...
```mermaid
graph TB
    ProductAggregate["ProductAggregate<br/>0 commands, 0 events"]
    OrderAggregate["OrderAggregate<br/>0 commands, 0 events"]
    CustomerAggregate["CustomerAggregate<br/>0 commands, 0 events"]

```

## Event Flow

Overview of domain events and their relationships.
