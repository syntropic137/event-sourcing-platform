...
class EventMetadata(_message.Message):
    ...
    def __init__(
        ...
        aggregate_nonce: _Optional[int] = ...,
        event_type: _Optional[str] = ...,
        event_version: _Optional[int] = ...,
        ...
        timestamp_unix_ms: _Optional[int] = ...,
        recorded_time_unix_ms: _Optional[int] = ...,
        payload_sha256: _Optional[bytes] = ...,
        headers: _Optional[_Mapping[str, str]] = ...,
        global_nonce: _Optional[int] = ...,
    ) -> None: ...
...
class EventData(_message.Message):
    ...
    def __init__(
        self,
        meta: _Optional[_Union[EventMetadata, _Mapping]] = ...,
...
class AppendRequest(_message.Message):
    ...
    def __init__(
        ...
        aggregate_id: _Optional[str] = ...,
        aggregate_type: _Optional[str] = ...,
        expected_aggregate_nonce: _Optional[int] = ...,
        idempotency_key: _Optional[str] = ...,
        events: _Optional[_Iterable[_Union[EventData, _Mapping]]] = ...,
    ) -> None: ...
...
class AppendResponse(_message.Message):
    ...
    def __init__(
        self, last_global_nonce: _Optional[int] = ..., last_aggregate_nonce: _Optional[int] = ...
    ) -> None: ...
...
class ReadStreamRequest(_message.Message):
    ...
    def __init__(
        ...
        tenant_id: _Optional[str] = ...,
        aggregate_id: _Optional[str] = ...,
        from_aggregate_nonce: _Optional[int] = ...,
...
class ReadStreamResponse(_message.Message):
    ...
    def __init__(
        ...
        events: _Optional[_Iterable[_Union[EventData, _Mapping]]] = ...,
        is_end: bool = ...,
        next_from_aggregate_nonce: _Optional[int] = ...,
    ) -> None: ...
...
class SubscribeRequest(_message.Message):
    ...
    def __init__(
        self,
        tenant_id: _Optional[str] = ...,
        aggregate_id_prefix: _Optional[str] = ...,
        from_global_nonce: _Optional[int] = ...,
    ) -> None: ...
...
class ReadAllResponse(_message.Message):
    ...
    def __init__(
        ...
        events: _Optional[_Iterable[_Union[EventData, _Mapping]]] = ...,
        is_end: bool = ...,
        next_from_global_nonce: _Optional[int] = ...,
    ) -> None: ...
...
class ConcurrencyErrorDetail(_message.Message):
    __slots__ = (
        "tenant_id",
        "aggregate_id",
        "actual_last_aggregate_nonce",
        "actual_last_global_nonce",
    )
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    AGGREGATE_ID_FIELD_NUMBER: _ClassVar[int]
